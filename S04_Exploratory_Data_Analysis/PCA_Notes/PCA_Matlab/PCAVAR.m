function y=pcavar(return_data, position_data, number_of_principal_components,cl)
% PCAVAR Estimates VaR by principal components analysis 
%
% Function estimates the VaR of a multi-position portfolio by principal components analysis, using 
...
%
[U,S,V]=svd(return_data,0);                  % SVD; provides U and V / Not the same as [U,S,V]=svd(return_data,0); 
svds(return_data,number_of_principal_components);% Returns required no of PC / Get the eigenvalues
...
% VaR
%
y=hsvar(synthetic_PandL_data,cl);                                    % VaR
